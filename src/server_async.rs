...
impl LanguageServer for Backend {
    async fn initialize(&self, params: InitializeParams) -> Result<InitializeResult> {
        ...
        Ok(self.workspace.get_server_capabilities())
    }
    ...
    async fn did_open(&self, params: DidOpenTextDocumentParams) {
        ...
        self.workspace.documents.insert(uri.clone(), Document { text, tree });
    ...
    async fn did_change(&self, params: DidChangeTextDocumentParams) {
        ...
        if let Some(mut document) = self.workspace.documents.get_mut(uri) {
    ...
    async fn completion(&self, params: CompletionParams) -> Result<Option<CompletionResponse>> {
        self.workspace.completion(&self.workspace.documents, params)
    }
    ...
    async fn hover(&self, params: HoverParams) -> Result<Option<Hover>> {
        ...
        match kind {
            "opcode" => {
                if let Some(instruction) = self.workspace.instructions.get(cursor_node_text) {
                    let documentation =
            ...
            "meta" => {
                if let Some(directive) = self.workspace.directives.get(cursor_node_text) {
                    return Ok(Some(Hover {
            ...
            "register" => {
                if let Some(register) = self.workspace.registers.numeric.get(cursor_node_text) {
                ...
                if let Some(register) = self.workspace.registers.common.get(cursor_node_text) {
                ...
                if let Some(register) = self.workspace.registers.float.get(cursor_node_text) {
